...
# Read V7 compiler to use as base, modify the specific parts
with open('build_v7_compiler.py', 'r', encoding='utf-8') as f:
    v7_code = f.read()

# I will just write the custom python script completely to avoid string replacement bugs
...
with open('build_v8_compiler.py', 'w', encoding='utf-8') as f:
    f.write(code)
